...
import co.xreos.celestialtestbench0.member.entities.YilmazYasyerli;
...
public class Runner {
    ...
    private static void registerMembers() {
        ...
        YilmazYasyerli yilmazyasyerli = new YilmazYasyerli();
        registry.registerMember(yilmazyasyerli);
