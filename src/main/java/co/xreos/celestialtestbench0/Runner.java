...
import co.xreos.celestialtestbench0.member.registry.AzizSelimCetin1;
...
public class Runner {
    ...
    private static void registerMembers() {
        AzizSelimCetin1 azizSelimCetin = new AzizSelimCetin1();
        registry.registerMember(azizSelimCetin);
    }
}
